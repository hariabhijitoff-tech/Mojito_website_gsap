...
const About = () => {
    ...
    useGSAP(() =>{
        ...
        scrollTimeline.from(titleSplit.words, {yPercent: 100, opacity: 0, duration: 1, ease: 'expo.out', stagger: 0.02})
            ...
            <div className="mb-16 md:px-0 px-5">
                <div className="content">
                    ...
                    <div className="sub-content">
                        <p>
                            Every Icocktail we serve is a reflection of our obsession with detail -
